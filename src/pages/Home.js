...
function Home() {
  ...
  return (
    <>
      <SeoMeta
        title="skyfaretravelsdeals.com - Best Flight & Travel Deals"
        description="Find the best flight deals, hotels, cruises and vacation packages at skyfaretravelsdeals.com. Book cheap flights and save on your next trip."
        keywords="flights, travel, deals, hotels, vacation, booking, cheap flights, airfare"
        image="https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=500"
        url="https://skyfaretravelsdeals.com/"
      />
      <div className="home">
