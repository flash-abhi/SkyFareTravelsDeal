...
class BookingEmailService {
  constructor() {
    this.fromEmail = process.env.EMAIL_USER || 'info@skyfaretravelsdeals.com';
              ...
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding: 8px;">
                    <a href="https://skyfaretravelsdeals.com/booking/${referenceNumber}" style="display: inline-block; background: linear-gradient(135deg, #0ea5e9, #6366f1); color: white; padding: 18px 40px; border-radius: 16px; text-decoration: none; font-weight: 800; font-size: 16px; box-shadow: 0 12px 32px rgba(14,165,233,0.4);">
                      📋 View Booking
                    </a>
                  </td>
                  <td style="padding: 8px;">
                    <a href="https://skyfaretravelsdeals.com/booking/${referenceNumber}?print=1" style="display: inline-block; background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 18px 40px; border-radius: 16px; text-decoration: none; font-weight: 800; font-size: 16px; box-shadow: 0 12px 32px rgba(16,185,129,0.4);">
                      🖨️ Print Ticket
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 40px; text-align: center;">
                    ...
                    <p style="margin: 20px 0 0; font-size: 14px;">
                      <a href="mailto:support@skyfaretravelsdeals.com" style="color: #0ea5e9; text-decoration: none;">support@skyfaretravelsdeals.com</a>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding: 24px; text-align: center;">
              <p style="margin: 0 0 16px;">
                <a href="https://skyfaretravelsdeals.com" style="color: #94a3b8; text-decoration: none; margin: 0 12px; font-size: 14px;">Website</a>
                <span style="color: #475569;">•</span>
                <a href="https://skyfaretravelsdeals.com/privacy" style="color: #94a3b8; text-decoration: none; margin: 0 12px; font-size: 14px;">Privacy</a>
                <span style="color: #475569;">•</span>
                <a href="https://skyfaretravelsdeals.com/terms" style="color: #94a3b8; text-decoration: none; margin: 0 12px; font-size: 14px;">Terms</a>
              </p>
              <p style="margin: 0; font-size: 13px; color: #64748b;">skyfaretravelsdeals.com</p>
