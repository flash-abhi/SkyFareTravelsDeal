...
class BlogPublisherService {
  ...
  async publishToMedium(blogPost) {
    ...
    const response = await axios.post(
      `https://api.medium.com/v1/users/${userId}/posts`,
      {
        ...
        canonicalUrl: `https://skyfaretravelsdeals.com/blog/${blogPost.slug}`
      },
      {
        headers: {
    ...
    const response = await axios.post(
      'https://dev.to/api/articles',
      {
        article: {
          ...
          canonical_url: `https://skyfaretravelsdeals.com/blog/${blogPost.slug}`,
  ...
  convertToMediumFormat(content) {
    ...
    return content + '\n\n---\n\n*Originally published at [skyfaretravelsdeals.com](https://skyfaretravelsdeals.com)*';
  }
        ...
        platforms: [
          {
            ...
            instructions: 'Copy content and paste. Add canonical URL to skyfaretravelsdeals.com',
            canonicalUrl: `https://skyfaretravelsdeals.com/blog/${blogPost.slug}`
          },
          {
            name: 'Dev.to',
          ...
          },
          {
            ...
            instructions: 'Write article, paste content, link back to skyfaretravelsdeals.com'
          },
          {
            name: 'Hashnode',
            da: 88,
