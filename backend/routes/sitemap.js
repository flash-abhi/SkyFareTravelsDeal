...
router.get('/sitemap.xml', (req, res) => {
  ...
  const baseUrl = process.env.SITE_URL || 'https://skyfaretravelsdeals.com';
...
<head>
  ...
  <title>Sitemap - skyfaretravelsdeals.com</title>
  <style>
...
<body>
  <div class="container">
    <h1>🗺️ Site Map</h1>
    <p class="subtitle">Complete navigation of skyfaretravelsdeals.com</p>
