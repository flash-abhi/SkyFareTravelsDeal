...
# Complete fresh deployment script for skyfaretravelsdeals VPS
# Run this on your VPS as: bash deploy-fresh.sh

set -e  # Exit on any error

VPS_IP="82.29.197.137"
DOMAIN="skyfaretravelsdeals.com"
DEPLOY_DIR="/var/www/skyfaretravelsdeals"
PM2_NAME="skyfaretravelsdeals-backend"
BACKEND_PORT=5001
...
cd /var/www
rm -rf skyfaretravelsdeals.backup 2>/dev/null || true
mv skyfaretravelsdeals skyfaretravelsdeals.backup 2>/dev/null || true
rm -rf flight.backup 2>/dev/null || true
mv flight flight.backup 2>/dev/null || true

# 3. Clone fresh from GitHub
echo "📥 Cloning from GitHub..."
git clone git@github.com:rawatsachin9-arch/skyfaretravelsdeals.git
cd skyfaretravelsdeals
...
server {
    ...
    server_name skyfaretravelsdeals.com www.skyfaretravelsdeals.com;
